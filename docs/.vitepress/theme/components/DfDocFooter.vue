...
<template>
  <div v-if="isDocFooterVisible" v-show="hasSidebar" class="df-doc-footer">
    <div class="df-doc-footer-message">
      <img
        v-if="!DEV"
        class="visitor"
    ...
    <p class="df-doc-footer-copyright" v-if="theme.footer?.copyright">
...
.df-doc-footer-message,
.df-doc-footer-copyright {
  display: flex;
  align-items: center;
}
